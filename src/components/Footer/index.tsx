  ...
  return (
    <footer className="overflow-hidden">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex ease-out duration-200 hover:text-dark-2"
              >
                <svg
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-luxury-text" href="#">
                  My Account
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-7.5 text-white rounded-md bg-luxury-text ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-dark ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
      ...
      <div className="py-5 xl:py-7.5 bg-gray-1">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-col md:flex-row flex-wrap items-center justify-between text-center md:text-left">
            <p className="text-dark font-medium w-full md:w-auto">

  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[270px] mb-4">
        <Image src={item?.imgs?.previews?.[0] || "/images/products/product-1-bg-1.png"} alt={item?.title || "Product"} width={250} height={250} loading="lazy" />
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 font-medium text-custom-sm py-[7px] px-5 rounded-[5px] ease-out duration-300"
            style={{
              background: addedToCart ? "#16a34a" : "#3B82F6",
              color: "#fff",
              transform: addedToCart ? "scale(1.07)" : "scale(1)",
            }}
          >
            {addedToCart ? (
              <>
          ...
          <button
            ...
            style={{
              background: savedToWishlist ? "#16a34a" : "#fff",
              color: savedToWishlist ? "#fff" : "#1a1a1a",
              transform: savedToWishlist ? "scale(1.15)" : "scale(1)",
            }}
            title={savedToWishlist ? "Saved!" : "Save to Wishlist"}
          >
            {savedToWishlist ? (

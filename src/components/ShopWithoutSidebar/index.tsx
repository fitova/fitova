...
const ShopWithoutSidebar = () => {
  ...
  return (
    <>
      ...
      />
      <section className="overflow-hidden relative pb-20 pt-5 lg:pt-20 xl:pt-28" style={{ background: "#F6F5F2" }}>
              ...
              >
                ...
                <div className="flex items-center gap-2.5">
                  <button
                    ...
                    className="flex items-center justify-center w-9 h-9 ease-out duration-200"
                    style={productStyle === "grid"
              ...
              >
                <ul className="flex items-center gap-1">
                  ...
                  <li>
                    <a
                      href="#"
                      className="flex py-1.5 px-3 text-xs font-light ease-out duration-200"

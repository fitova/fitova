              ...
              <div className="flex items-center gap-5">
                {user ? (
                  ...
                  >
                    {user.user_metadata?.avatar_url ? (
                      ...
                      <span
                        className="flex items-center justify-center w-8 h-8 rounded-full text-white text-xs font-medium flex-shrink-0"
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-custom-sm text-dark flex items-center gap-1.5">
                        <Link href="/signin" className="hover:text-blue">
                          Sign In
                        </Link>
                        <span className="text-gray-4">/</span>
                        <Link href="/signup" className="hover:text-blue">
                          Sign Up
                        </Link>
                      </p>
                    </div>
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-dark w-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>

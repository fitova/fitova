      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div className="bg-white rounded-[10px] shadow-sm border border-[#E8E4DF]">
              <div className="w-full">
                <div className="flex flex-col">
                  {/* <!-- table header (hidden on mobile) --> */}
                  <div className="hidden md:flex items-center py-5.5 px-7.5 border-b border-[#E8E4DF] bg-[#FAFAF9] rounded-t-[10px]">
                    <div className="md:w-5/12 lg:w-[400px]">
                      <p className="text-sm font-medium tracking-wide text-[#0A0A0A] uppercase">Product</p>
                    </div>

                    <div className="md:w-2/12 lg:w-[180px]">
                      <p className="text-sm font-medium tracking-wide text-[#0A0A0A] uppercase">Price</p>
                    </div>

                    <div className="md:w-2/12 lg:w-[275px]">
                      <p className="text-sm font-medium tracking-wide text-[#0A0A0A] uppercase">Quantity</p>
                    </div>

                    <div className="md:w-2/12 lg:w-[200px]">
                      <p className="text-sm font-medium tracking-wide text-[#0A0A0A] uppercase">Subtotal</p>
                    </div>

                    <div className="md:w-1/12 lg:w-[50px] ml-auto">
                      <p className="text-sm font-medium tracking-wide text-[#0A0A0A] uppercase text-right">Action</p>
                    </div>
                  </div>
